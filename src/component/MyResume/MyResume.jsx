    ...
    >
      <div data-aos="fade-right" className=" md:w-6/12">
        ...
        <div className="grid flex-grow card rounded-box ">
          ...
          <p className=" font-mono mt-1 ">
            I have not completed Higher Secondary School Certificate, I am
            studying in Higher Secondary School Certificate, I am admitted in
      ...
      <div data-aos="fade-left" className="md:w-6/12">
        ...
        <div className="grid flex-grow card rounded-box ">
          ...
          <p className=" font-mono">
            I have competed Mern-stack developing from programming hero courses{" "}
          </p>
        </div>
      </div>
    </motion.div>
