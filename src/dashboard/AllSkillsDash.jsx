...
const AllSkillsDash = () => {
  ...
  return (
    <div className="p-5">
      <h1 className="text-3xl font-semibold text-black text-center pb-8">All Skills</h1>
          ...
          <table className="w-full min-w-max table-auto text-left">
            ...
            <tbody>
              {skills.map((skill, index) => (
                <ShowSkills key={skill?._id} skill={skill} index={index} />
              ))}
            </tbody>
          </table>
        </Card>
