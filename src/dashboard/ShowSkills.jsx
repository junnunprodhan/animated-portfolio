...
const ShowSkills = ({
  ...
  const { mutateAsync } = useMutation({
    mutationFn: async (id) => {
      return await baseApiAxios.delete(`/delete-skill/${id}`);
    },
    onSuccess: () => {
  ...
  return (
    <tr key={skill?._id} className="even:bg-blue-gray-50/50">
      ...
      <td className="p-4">
        ...
        >
          <img src={skill?.img} alt="" className="w-[100px] h-[100px] rounded-lg" />
        </Typography>
      </td>
      <td className="p-4">
        <Typography
